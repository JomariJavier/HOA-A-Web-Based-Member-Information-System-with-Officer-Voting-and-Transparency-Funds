export default function BaseLayout({ currentView, onNavClick, isAdmin, children }) {
    return (
        <div className="app-layout">
            <aside className="app-sidebar">
                ...
                <nav>
                    ...
                    {isAdmin && <div className={`nav-item ${currentView === 'PIS' ? 'active' : ''}`} onClick={() => onNavClick('PIS')}>HOA Personal Information</div>}
            ...
            <main className="app-main">
                <header className="app-top-header">
                    ...
                    <div className="user-profile">{isAdmin ? 'Officer Mode' : 'Member Mode'}</div>
                </header>
