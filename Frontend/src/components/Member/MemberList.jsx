    ...
    const renderRegistration = () => (
        <div className="m3-directory">
            ...
            <div className="m3-registration-card">
                <form onSubmit={(e) => { e.preventDefault(); handleRegisterSubmit(newMember); }}>
                    ...
                    <div className="m3-registration-actions">
                        <button type="button" className="m3-text-btn-large" onClick={() => setView('list')}>Cancel Registration</button>
